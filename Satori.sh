...
echo "#################################################"
echo ""
echo "第一步安装完后 请手动执行三条命令cd $HOME/.satori || bash $HOME/.satori/install.sh || bash $HOME/.satori/install_service.sh"
echo ""
...
function install_satori() {
    ...
    mkdir -p ./config
    # 设置默认推荐码
    echo 0236ff9f79b4cfed36f703ddb4a58dd3fa0e22cad5517f40be05a038fe09e719ab >> ./config/referral.txt
